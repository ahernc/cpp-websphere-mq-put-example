 ...
 /****************************************************************/
 /* <BEGIN_BUILDINFO>                                            */
 /* Generated on:  02/10/13 17:17                                */
 /* Build Level:   p750-002-131001_DE                            */
 ...
 #define MQSCO_CURRENT_VERSION          4
...
#endif
#if defined(MQ_64_BIT)
 #define MQSCO_CURRENT_LENGTH           568
#else
 #define MQSCO_CURRENT_LENGTH           560
#endif
 ...
 #define MQCNO_CURRENT_VERSION          5
...
#endif
#if defined(MQ_64_BIT)
 #define MQCNO_CURRENT_LENGTH           200
#else
 #define MQCNO_CURRENT_LENGTH           188
#endif
 ...
 #define MQ_MCA_USER_ID_LENGTH          64
 ...
 #define MQCMDL_CURRENT_LEVEL           750
